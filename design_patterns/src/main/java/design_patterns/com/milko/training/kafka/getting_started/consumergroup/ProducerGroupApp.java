...
//        props.put("max.in.flight.requests.per.connection", 5);
        ...
        String topic = "my-group-topic";

        
        int numberOfRecords = 100; // number of records to send
        long sleepTimer = 100; // how long you want to wait before the next record to be sent
        ...
        try {
             ...
             //       myProducer.send(new ProducerRecord<String, String>(topic, String.format("new Message from Milko: %s  sent at %s", Integer.toString(i), dtFormat.format(new Date()))));
                	myProducer.send(new ProducerRecord<String, String>(topic, "abcdefgghjewpiorewrewjkfds"));
